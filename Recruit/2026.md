...
Với hai thứ này, ta có thể tính offset từ return address tới hàm win và dùng thao tác update để nhảy vào hàm win và spawn shell (chú ý rsp 0x10 alignment)
