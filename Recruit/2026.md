...
Với address của libc_start_main và address của một hàm nào đó trong binary, ta có thể tính exe_base và libc_base, từ đó tính offset từ return address (libc_start_main) tới hàm win (một hàm trong binary) và dùng thao tác update để chỉnh sưa để nhảy vào hàm win và spawn shell (chú ý rsp 0x10 alignment)
