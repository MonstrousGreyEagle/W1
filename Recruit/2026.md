...
Và vì Fenwick tree nhảy bit để tính tổng (ví dụ phần từ thứ  + phần tử thứ 40 +), ta có thể dịch từ từ con trỏ để có thể tính các address trên stack, bao gồm return address (libc_start_main), và một vài exe address (một số hàm init trước main)
